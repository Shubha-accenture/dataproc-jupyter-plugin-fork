...
//import { expect, test } from '../tests/galata-base';
...
test.describe('Launcher screen', () => {
    test('Sanity: Can verify all the sections', async ({ page }) => {
        ...
        // Check Dataproc Serverless Notebooks section with new runtime template card is available
        ...
        // Check Dataproc Cluster Notebooks section
        ...
        // Verify Google Cloud Resources section and cards
