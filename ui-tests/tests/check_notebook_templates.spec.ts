...
test.describe('Notebook Template tests', () => {
    ...
    async function navigateToNotebookTemplates(page: Page) {
    ...
    test.skip('Can confirm the details by opening a notebook template', async ({ page }) => {
        test.setTimeout(timeout);
