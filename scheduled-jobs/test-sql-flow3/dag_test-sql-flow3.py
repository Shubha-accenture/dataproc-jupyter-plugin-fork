...
read_sql_query_task_2 = PythonOperator(
    ...
    op_kwargs={'gcs_path': 'gs://us-central1-test-am-5a4039ed-bucket/dataproc-notebooks/test-sql-flow3/input_notebooks/sqlfile.sql', 'service_account':'accenture-eng-test@dataproc-jupyter-extension-dev.iam.gserviceaccount.com'},
