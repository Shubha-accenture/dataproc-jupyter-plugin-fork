...
service_account = '411524708443-compute@developer.gserviceaccount.com'
...
read_sql_query_task_2 = PythonOperator(
    ...
    op_kwargs={'gcs_path': 'gs://us-central1-multinode-sched-5c1e56e9-bucket/dataproc-notebooks/testbq-sql-flow/input_notebooks/sqlfile.sql', 'service_account':'411524708443-compute@developer.gserviceaccount.com'},
...
prepare_config_task_2 = PythonOperator(
    ...
    op_kwargs={'id': '2','projectId': 'dataproc-jupyter-extension-dev', 'datasetId': '', 'tableId': '', 'writeDisposition':'WRITE_TRUNCATE'},
    provide_context=True,
    dag=dag,
)
...
def run_bigquery_insert_job_2(**kwargs):
    ...
    insert_job = BigQueryInsertJobOperator(
        ...
        location='africa-south1',  # Specify your BigQuery location
