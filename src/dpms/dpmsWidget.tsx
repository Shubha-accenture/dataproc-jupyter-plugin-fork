...
import { DpmsService } from './dpmsServices';
...
const DpmsComponent = ({
  ...
  const getColumnDetails = async (name: string) => {
    await DpmsService.getColumnDetailsService(
      name,
      notebookValue,
      setColumnResponse,
      setIsLoading,
  ...
  const getTableDetails = async (database: string) => {
    await DpmsService.getTableDetailsService(
      database,
      notebookValue,
...
fetching database name from fully qualified name structure */
  ...
  const getDatabaseDetails = async () => {
    await DpmsService.getDatabaseDetailsService(
      notebookValue,
      dataprocMetastoreServices,
      setDatabaseDetails,
      setDatabaseNames,
  ...
  const getClusterDetails = async () => {
    await DpmsService.getClusterDetailsService(
      notebookValue,
      setIsLoading,
      setCluster,
      setNoDpmsInstance,
  ...
  const getSessionDetails = async () => {
    await DpmsService.getSessionDetailsService(
      notebookValue,
      setIsLoading,
      setSession,
      setNoDpmsInstance,
